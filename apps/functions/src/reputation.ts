...
export const REPUTATION_ACTIONS: Record<ReputationActionCode, ReputationActionDefinition> = {
  ...
  C_CANCEL_G24: { code: 'C_CANCEL_G24', role: 'CANDIDATE', labelVi: 'Hủy đơn trước ca hơn 24 giờ', points: -5, direction: 'PENALTY' },
  C_CANCEL_2_24: { code: 'C_CANCEL_2_24', role: 'CANDIDATE', labelVi: 'Hủy đơn trong khoảng 2-24 giờ trước ca', points: -15, direction: 'PENALTY' },

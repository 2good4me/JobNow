...
export function CategoryBottomSheet({
  ...
  return (
    <>
      ...
      <div
        ref={sheetRef}
        className={`fixed bottom-0 left-0 right-0 z-50 rounded-t-3xl border border-t-slate-200 bg-white shadow-[0_-8px_32px_rgba(0,0,0,0.12)] transition-all duration-300 ease-out ${
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-slate-100 px-4 py-4">
          <h2 className="text-lg font-bold text-slate-900">Chọn ngành nghề</h2>
          <button
            onClick={onClose}

...
export const Route = createFileRoute('/employer/profile/settings/phone')({
  component: EmployerSettingsPhonePage,
});

function EmployerSettingsPhonePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 pb-24 max-w-lg mx-auto w-full relative shadow-sm">
      <div className="bg-[#1e3a5f] text-white p-4 sticky top-0 z-10 flex items-center">
        ...
        <h1 className="text-lg font-bold ml-2">Xac minh dien thoai</h1>
      </div>

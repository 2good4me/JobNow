...
export const Route = createFileRoute('/employer/profile/settings/terms')({
  component: EmployerSettingsTermsPage,
});

function EmployerSettingsTermsPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 pb-24 max-w-lg mx-auto w-full relative shadow-sm">
      <div className="bg-[#1e3a5f] text-white p-4 sticky top-0 z-10 flex items-center">
        ...
        <h1 className="text-lg font-bold ml-2">Dieu khoan dich vu</h1>
      </div>
      <div className="max-w-md mx-auto p-4">
        <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100">
          Noi dung dieu khoan dang duoc cap nhat.
        </div>
      </div>
    </div>
  );

...
export const Route = createFileRoute('/employer/profile/settings/deactivate')({
  component: EmployerSettingsDeactivatePage,
});

function EmployerSettingsDeactivatePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-24">
      <div className="bg-[#1e3a5f] text-white p-4 sticky top-0 z-10 flex items-center">
        ...
        <h1 className="text-lg font-bold ml-2">Tat tai khoan</h1>
      </div>

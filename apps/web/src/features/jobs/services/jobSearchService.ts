import { collection, getDocs, query, doc, getDoc, orderBy, limit as queryLimit } from 'firebase/firestore';
...
export async function fetchAllJobs(): Promise<Job[]> {
    ...
    const q = query(jobsRef, orderBy('created_at', 'desc'), queryLimit(50));
